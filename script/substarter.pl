...
=head1 USAGE
  ...
  substarter.pl [<options>] [<file>] ...
  substarter.pl --usage|help|version|man
...
C</etc/substarterrc> is scanned, if it exists.  Then, the
file C<~/.substarterrc> is scanned, if it exists.  Then,
